...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})};Ox.createRoot(document.getElementById("root")).render(F.jsx(ie.StrictMode,{children:F.jsx(KS,{children:F.jsxs(wS,{children:[F.jsx(qc,{path:"/web-hub",element:F.jsx(JM,{})}),F.jsx(qc,{path:"/web-hub/network-quiz",element:F.jsx($M,{})}),F.jsx(qc,{path:"/web-hub/neonspace",element:F.jsx(DR,{})})]})})}));
